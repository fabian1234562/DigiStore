      ...
      <div className="relative w-full max-w-2xl bg-white rounded-2xl border border-blue-200 shadow-premium-lg my-8" onClick={e => e.stopPropagation()}>
        ...
        <div className="p-6 space-y-4">
          ...
          {app.claimInstructions && (
            <div className="rounded-xl bg-blue-50 border border-blue-200 p-4">
              <h4 className="text-xs font-bold text-blue-700 uppercase tracking-wider flex items-center gap-1.5 mb-2">
                <Download className="w-3.5 h-3.5" /> Instrucciones de instalación
              </h4>
          ...
          <div className="pt-2">
            ...
            {/* UN SOLO BOTON: Descargar ahora - abre el instalador en nueva pestaña */}
            {app.claimUrl && (
              <a
                href={app.claimUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 px-6 py-4 text-base font-bold text-white transition-all shadow-lg hover:shadow-xl hover:scale-[1.02]"
              >
