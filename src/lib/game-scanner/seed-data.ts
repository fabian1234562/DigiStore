...
4. ¡Empieza a streamear!` }),
  ...
  makeGame({ id: 'app-rvc-webui', title: 'RVC Voice Cloning WebUI', source: 'software', originalPrice: 59.99, genre: 'IA Clonación de Voz',
    description: 'Clona cualquier voz con menos de 10 minutos de audio. Entrena tu modelo de voz personal. La herramienta de clonación de voz open source más popular del mundo. Crea covers de canciones, voces personalizadas, doblaje. Software oficial: RVC Voice Cloning WebUI. GitHub: https://github.com/RVC-Project/Retrieval-based-Voice-Conversion-WebUI. Estrellas: 38,050. Descarga: https://github.com/RVC-Project/Retrieval-based-Voice-Conversion-WebUI/releases.',
    imageUrl: '/products/apps/app-rvc-webui.svg',
    steamUrl: 'https://github.com/RVC-Project/Retrieval-based-Voice-Conversion-WebUI/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-clonación-de-voz', 'premium'],
    claimInstructions: 'Descarga RVC Voice Cloning WebUI:\n1. Visita https://github.com/RVC-Project/Retrieval-based-Voice-Conversion-WebUI/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! RVC Voice Cloning WebUI es 100% open source' }),
  makeGame({ id: 'app-gpt-sovits', title: 'GPT-SoVITS', source: 'software', originalPrice: 59.99, genre: 'IA Clonación de Voz',
    description: 'Clona una voz con solo 1 minuto de audio. Soporta múltiples idiomas incluyendo español. IA de última generación para clonación de voz y TTS. La más avanzada open source. Software oficial: GPT-SoVITS. GitHub: https://github.com/RVC-Boss/GPT-SoVITS. Estrellas: 61,515. Descarga: https://github.com/RVC-Boss/GPT-SoVITS/releases.',
    imageUrl: '/products/apps/app-gpt-sovits.svg',
    steamUrl: 'https://github.com/RVC-Boss/GPT-SoVITS/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-clonación-de-voz', 'premium'],
    claimInstructions: 'Descarga GPT-SoVITS:\n1. Visita https://github.com/RVC-Boss/GPT-SoVITS/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! GPT-SoVITS es 100% open source' }),
  makeGame({ id: 'app-so-vits-svc', title: 'So-VITS-SVC', source: 'software', originalPrice: 59.99, genre: 'IA Clonación de Voz',
    description: 'Conversión de voz para cantar. Transforma tu voz en la de cualquier cantante. Soporta entrenamiento con datasets pequeños. Ideal para covers musicales con IA. Software oficial: So-VITS-SVC. GitHub: https://github.com/svc-develop-team/so-vits-svc. Estrellas: 28,113. Descarga: https://github.com/svc-develop-team/so-vits-svc/releases.',
    imageUrl: '/products/apps/app-so-vits-svc.svg',
    steamUrl: 'https://github.com/svc-develop-team/so-vits-svc/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-clonación-de-voz', 'premium'],
    claimInstructions: 'Descarga So-VITS-SVC:\n1. Visita https://github.com/svc-develop-team/so-vits-svc/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! So-VITS-SVC es 100% open source' }),
  makeGame({ id: 'app-coqui-tts', title: 'Coqui TTS', source: 'software', originalPrice: 59.99, genre: 'IA Texto a Voz',
    description: 'Toolkit de texto a voz con deep learning. Soporta múltiples voces, idiomas y modelos. Genera voz natural desde texto. La mejor alternativa open source a ElevenLabs. Software oficial: Coqui TTS. GitHub: https://github.com/coqui-ai/TTS. Estrellas: 45,983. Descarga: https://github.com/coqui-ai/TTS/releases.',
    imageUrl: '/products/apps/app-coqui-tts.svg',
    steamUrl: 'https://github.com/coqui-ai/TTS/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-texto-a-voz', 'premium'],
    claimInstructions: 'Descarga Coqui TTS:\n1. Visita https://github.com/coqui-ai/TTS/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! Coqui TTS es 100% open source' }),
  makeGame({ id: 'app-voicebox', title: 'Voicebox AI Studio', source: 'software', originalPrice: 59.99, genre: 'IA Texto a Voz',
    description: 'Estudio de voz IA open source. Clona voces, dicta, crea narraciones. La alternativa libre a ElevenLabs y Murf. Interfaz intuitiva para creadores de contenido. Software oficial: Voicebox AI Studio. GitHub: https://github.com/jamiepine/voicebox. Estrellas: 52,239. Descarga: https://github.com/jamiepine/voicebox/releases.',
    imageUrl: '/products/apps/app-voicebox.svg',
    steamUrl: 'https://github.com/jamiepine/voicebox/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-texto-a-voz', 'premium'],
    claimInstructions: 'Descarga Voicebox AI Studio:\n1. Visita https://github.com/jamiepine/voicebox/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! Voicebox AI Studio es 100% open source' }),
  makeGame({ id: 'app-cosyvoice', title: 'CosyVoice', source: 'software', originalPrice: 59.99, genre: 'IA Texto a Voz',
    description: 'Modelo de generación de voz multilingüe. Soporta español, inglés, chino y más. Clonación de voz con alta fidelidad. TTS con control de emoción. Software oficial: CosyVoice. GitHub: https://github.com/QwenAudio/CosyVoice. Estrellas: 23,444. Descarga: https://github.com/QwenAudio/CosyVoice.',
    imageUrl: '/products/apps/app-cosyvoice.svg',
    steamUrl: 'https://github.com/QwenAudio/CosyVoice',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-texto-a-voz', 'premium'],
    claimInstructions: 'Descarga CosyVoice:\n1. Visita https://github.com/QwenAudio/CosyVoice\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! CosyVoice es 100% open source' }),
  makeGame({ id: 'app-moneyprinter', title: 'MoneyPrinterTurbo', source: 'software', originalPrice: 59.99, genre: 'IA Generación de Video',
    description: 'Genera videos cortos en HD automáticamente con IA. Solo ingresa un tema o palabra clave y la IA crea el video completo con guion, voz, subtítulos y visuales. Para TikTok, YouTube Shorts, Reels. Software oficial: MoneyPrinterTurbo. GitHub: https://github.com/harry0703/MoneyPrinterTurbo. Estrellas: 120,227. Descarga: https://github.com/harry0703/MoneyPrinterTurbo/releases.',
    imageUrl: '/products/apps/app-moneyprinter.svg',
    steamUrl: 'https://github.com/harry0703/MoneyPrinterTurbo/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-generación-de-video', 'premium'],
    claimInstructions: 'Descarga MoneyPrinterTurbo:\n1. Visita https://github.com/harry0703/MoneyPrinterTurbo/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! MoneyPrinterTurbo es 100% open source' }),
  makeGame({ id: 'app-cogvideo', title: 'CogVideoX', source: 'software', originalPrice: 59.99, genre: 'IA Generación de Video',
    description: 'Generación de video desde texto e imagen con IA. Crea videos desde descripciones textuales. Modelo de última generación de Zhipu AI. Open source. Software oficial: CogVideoX. GitHub: https://github.com/zai-org/CogVideo. Estrellas: 13,000. Descarga: https://github.com/zai-org/CogVideo.',
    imageUrl: '/products/apps/app-cogvideo.svg',
    steamUrl: 'https://github.com/zai-org/CogVideo',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-generación-de-video', 'premium'],
    claimInstructions: 'Descarga CogVideoX:\n1. Visita https://github.com/zai-org/CogVideo\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! CogVideoX es 100% open source' }),
  makeGame({ id: 'app-ltx-video', title: 'LTX-Video', source: 'software', originalPrice: 59.99, genre: 'IA Generación de Video',
    description: 'Generador de video con IA de Lightricks. Crea videos desde texto con alta calidad. Modelo de difusión para video. Open source, rápido y eficiente. Software oficial: LTX-Video. GitHub: https://github.com/Lightricks/LTX-Video. Estrellas: 10,931. Descarga: https://github.com/Lightricks/LTX-Video.',
    imageUrl: '/products/apps/app-ltx-video.svg',
    steamUrl: 'https://github.com/Lightricks/LTX-Video',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-generación-de-video', 'premium'],
    claimInstructions: 'Descarga LTX-Video:\n1. Visita https://github.com/Lightricks/LTX-Video\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! LTX-Video es 100% open source' }),
  makeGame({ id: 'app-deep-live-cam', title: 'Deep-Live-Cam', source: 'software', originalPrice: 59.99, genre: 'IA Face Swap',
    description: 'Face swap en tiempo real para streaming y videollamadas. Cambia tu cara por la de cualquier persona en vivo. Detección facial con IA. Para OBS, Zoom, Discord. Software oficial: Deep-Live-Cam. GitHub: https://github.com/hacksider/Deep-Live-Cam. Estrellas: 96,480. Descarga: https://github.com/hacksider/Deep-Live-Cam/releases.',
    imageUrl: '/products/apps/app-deep-live-cam.svg',
    steamUrl: 'https://github.com/hacksider/Deep-Live-Cam/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-face-swap', 'premium'],
    claimInstructions: 'Descarga Deep-Live-Cam:\n1. Visita https://github.com/hacksider/Deep-Live-Cam/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! Deep-Live-Cam es 100% open source' }),
  makeGame({ id: 'app-faceswap', title: 'FaceSwap (Deepfakes)', source: 'software', originalPrice: 59.99, genre: 'IA Face Swap',
    description: 'Software de deepfakes para todos. Crea videos con intercambio de rostros. La herramienta de deepfake open source más popular. Para creadores de contenido. Software oficial: FaceSwap (Deepfakes). GitHub: https://github.com/deepfakes/faceswap. Estrellas: 57,520. Descarga: https://github.com/deepfakes/faceswap/releases.',
    imageUrl: '/products/apps/app-faceswap.svg',
    steamUrl: 'https://github.com/deepfakes/faceswap/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-face-swap', 'premium'],
    claimInstructions: 'Descarga FaceSwap (Deepfakes):\n1. Visita https://github.com/deepfakes/faceswap/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! FaceSwap (Deepfakes) es 100% open source' }),
  makeGame({ id: 'app-deepfacelive', title: 'DeepFaceLive', source: 'software', originalPrice: 59.99, genre: 'IA Face Swap',
    description: 'Face swap en tiempo real para PC streaming. Intercambia tu rostro en videollamadas y streams. Compatible con webcam. Detección facial avanzada. Software oficial: DeepFaceLive. GitHub: https://github.com/iperov/DeepFaceLive. Estrellas: 31,010. Descarga: https://github.com/iperov/DeepFaceLive/releases.',
    imageUrl: '/products/apps/app-deepfacelive.svg',
    steamUrl: 'https://github.com/iperov/DeepFaceLive/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-face-swap', 'premium'],
    claimInstructions: 'Descarga DeepFaceLive:\n1. Visita https://github.com/iperov/DeepFaceLive/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! DeepFaceLive es 100% open source' }),
  makeGame({ id: 'app-deepfacelab', title: 'DeepFaceLab', source: 'software', originalPrice: 59.99, genre: 'IA Face Swap',
    description: 'El software líder para crear deepfakes. Máxima calidad de intercambio de rostros. Usado por creadores profesionales. La herramienta de deepfake más potente. Software oficial: DeepFaceLab. GitHub: https://github.com/iperov/DeepFaceLab. Estrellas: 19,287. Descarga: https://github.com/iperov/DeepFaceLab/releases.',
    imageUrl: '/products/apps/app-deepfacelab.svg',
    steamUrl: 'https://github.com/iperov/DeepFaceLab/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-face-swap', 'premium'],
    claimInstructions: 'Descarga DeepFaceLab:\n1. Visita https://github.com/iperov/DeepFaceLab/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! DeepFaceLab es 100% open source' }),
  makeGame({ id: 'app-sd-webui', title: 'Stable Diffusion WebUI', source: 'software', originalPrice: 59.99, genre: 'IA Generación de Imagen',
    description: 'Interfaz web de Stable Diffusion. Genera imágenes desde texto con IA. La herramienta de generación de imágenes open source más popular. Miles de modelos disponibles. Alternativa libre a Midjourney. Software oficial: Stable Diffusion WebUI. GitHub: https://github.com/AUTOMATIC1111/stable-diffusion-webui. Estrellas: 164,792. Descarga: https://github.com/AUTOMATIC1111/stable-diffusion-webui/releases.',
    imageUrl: '/products/apps/app-sd-webui.svg',
    steamUrl: 'https://github.com/AUTOMATIC1111/stable-diffusion-webui/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-generación-de-imagen', 'premium'],
    claimInstructions: 'Descarga Stable Diffusion WebUI:\n1. Visita https://github.com/AUTOMATIC1111/stable-diffusion-webui/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! Stable Diffusion WebUI es 100% open source' }),
  makeGame({ id: 'app-comfyui', title: 'ComfyUI', source: 'software', originalPrice: 59.99, genre: 'IA Generación de Imagen',
    description: 'Interfaz modular y potente para modelos de difusión. Flujo de nodos visual para generación de imágenes. La herramienta más flexible para artistas de IA. Soporta Stable Diffusion y más. Software oficial: ComfyUI. GitHub: https://github.com/Comfy-Org/ComfyUI. Estrellas: 131,373. Descarga: https://github.com/comfyanonymous/ComfyUI/releases.',
    imageUrl: '/products/apps/app-comfyui.svg',
    steamUrl: 'https://github.com/comfyanonymous/ComfyUI/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-generación-de-imagen', 'premium'],
    claimInstructions: 'Descarga ComfyUI:\n1. Visita https://github.com/comfyanonymous/ComfyUI/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! ComfyUI es 100% open source' }),
  makeGame({ id: 'app-whisper-cpp', title: 'Whisper.cpp', source: 'software', originalPrice: 59.99, genre: 'IA Transcripción',
    description: 'Port de Whisper de OpenAI en C/C++. Transcripción de audio a texto de alta calidad. Funciona offline, sin internet. Soporta 99 idiomas. Rápido y ligero. Software oficial: Whisper.cpp. GitHub: https://github.com/ggml-org/whisper.cpp. Estrellas: 53,422. Descarga: https://github.com/ggml-org/whisper.cpp/releases.',
    imageUrl: '/products/apps/app-whisper-cpp.svg',
    steamUrl: 'https://github.com/ggml-org/whisper.cpp/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-transcripción', 'premium'],
    claimInstructions: 'Descarga Whisper.cpp:\n1. Visita https://github.com/ggml-org/whisper.cpp/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! Whisper.cpp es 100% open source' }),
  makeGame({ id: 'app-whisperx', title: 'WhisperX', source: 'software', originalPrice: 59.99, genre: 'IA Transcripción',
    description: 'Reconocimiento de voz con alineación a nivel de palabra. Transcripción precisa con timestamps por palabra. Soporta identificación de hablantes. Mejora del Whisper de OpenAI. Software oficial: WhisperX. GitHub: https://github.com/m-bain/whisperX. Estrellas: 23,879. Descarga: https://github.com/m-bain/whisperX/releases.',
    imageUrl: '/products/apps/app-whisperx.svg',
    steamUrl: 'https://github.com/m-bain/whisperX/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-transcripción', 'premium'],
    claimInstructions: 'Descarga WhisperX:\n1. Visita https://github.com/m-bain/whisperX/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! WhisperX es 100% open source' }),
  makeGame({ id: 'app-ollama', title: 'Ollama', source: 'software', originalPrice: 59.99, genre: 'IA Chat Local',
    description: 'Ejecuta LLMs (Llama, Mistral, Gemma, Phi) localmente en tu PC. Sin internet, sin nube. Tu IA privada y personal. La forma más fácil de usar LLMs localmente. Alternativa libre a ChatGPT. Software oficial: Ollama. GitHub: https://github.com/ollama/ollama. Estrellas: 180,075. Descarga: https://ollama.com/download.',
    imageUrl: '/products/apps/app-ollama.svg',
    steamUrl: 'https://ollama.com/download',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-chat-local', 'premium'],
    claimInstructions: 'Descarga Ollama:\n1. Visita https://ollama.com/download\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! Ollama es 100% open source' }),
  makeGame({ id: 'app-khoj', title: 'Khoj AI', source: 'software', originalPrice: 59.99, genre: 'IA Chat Local',
    description: 'Tu segundo cerebro con IA. Self-hostable. Busca respuestas en tus documentos, emails y notas. Chat con IA sobre tu conocimiento personal. Alternativa libre a Notion AI. Software oficial: Khoj AI. GitHub: https://github.com/khoj-ai/khoj. Estrellas: 37,048. Descarga: https://khoj.dev/download.',
    imageUrl: '/products/apps/app-khoj.svg',
    steamUrl: 'https://khoj.dev/download',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-chat-local', 'premium'],
    claimInstructions: 'Descarga Khoj AI:\n1. Visita https://khoj.dev/download\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! Khoj AI es 100% open source' }),
  makeGame({ id: 'app-livetalking', title: 'LiveTalking', source: 'software', originalPrice: 59.99, genre: 'IA Lip Sync',
    description: 'Humano digital interactivo en tiempo real. Lip sync con IA para streaming. Crea avatares que hablan en vivo. Combinable con TTS y LLMs. Software oficial: LiveTalking. GitHub: https://github.com/lipku/LiveTalking. Estrellas: 9,377. Descarga: https://github.com/lipku/LiveTalking.',
    imageUrl: '/products/apps/app-livetalking.svg',
    steamUrl: 'https://github.com/lipku/LiveTalking',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'ia-lip-sync', 'premium'],
    claimInstructions: 'Descarga LiveTalking:\n1. Visita https://github.com/lipku/LiveTalking\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! LiveTalking es 100% open source' }),
  makeGame({ id: 'app-sherlock', title: 'Sherlock OSINT', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Busca cuentas de redes sociales por nombre de usuario en 400+ plataformas. Herramienta OSINT open source para investigadores y periodistas. Encuentra perfiles en redes sociales. Software oficial: Sherlock OSINT. GitHub: https://github.com/sherlock-project/sherlock. Estrellas: 90,902. Descarga: https://github.com/sherlock-project/sherlock.',
    imageUrl: '/products/apps/app-sherlock.svg',
    steamUrl: 'https://github.com/sherlock-project/sherlock',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'hackeo-ético', 'premium'],
    claimInstructions: 'Descarga Sherlock OSINT:\n1. Visita https://github.com/sherlock-project/sherlock\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! Sherlock OSINT es 100% open source' }),
  makeGame({ id: 'app-imhex', title: 'ImHex Hex Editor', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Editor hex para ingenieros inversos. Analiza binarios, firmware, malware. Soporta patrones, ensamblador, decompilador. La herramienta de reverse engineering más popular. Software oficial: ImHex Hex Editor. GitHub: https://github.com/WerWolv/ImHex. Estrellas: 54,673. Descarga: https://github.com/WerWolv/ImHex/releases.',
    imageUrl: '/products/apps/app-imhex.svg',
    steamUrl: 'https://github.com/WerWolv/ImHex/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'hackeo-ético', 'premium'],
    claimInstructions: 'Descarga ImHex Hex Editor:\n1. Visita https://github.com/WerWolv/ImHex/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! ImHex Hex Editor es 100% open source' }),
  makeGame({ id: 'app-trivy', title: 'Trivy Vulnerability Scanner', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Escáner de vulnerabilidades para contenedores, Kubernetes, IaC. Encuentra CVEs, secretos, misconfiguraciones. Herramienta esencial para DevSecOps. Software oficial: Trivy Vulnerability Scanner. GitHub: https://github.com/aquasecurity/trivy. Estrellas: 37,769. Descarga: https://github.com/aquasecurity/trivy/releases.',
    imageUrl: '/products/apps/app-trivy.svg',
    steamUrl: 'https://github.com/aquasecurity/trivy/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'hackeo-ético', 'premium'],
    claimInstructions: 'Descarga Trivy Vulnerability Scanner:\n1. Visita https://github.com/aquasecurity/trivy/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! Trivy Vulnerability Scanner es 100% open source' }),
  makeGame({ id: 'app-maigret', title: 'Maigret OSINT', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Recopila un dossier completo de una persona por su nombre de usuario. Busca en 2000+ sitios. Herramienta OSINT para investigadores. Encuentra perfiles, datos y conexiones. Software oficial: Maigret OSINT. GitHub: https://github.com/soxoj/maigret. Estrellas: 37,280. Descarga: https://github.com/soxoj/maigret.',
    imageUrl: '/products/apps/app-maigret.svg',
    steamUrl: 'https://github.com/soxoj/maigret',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'hackeo-ético', 'premium'],
    claimInstructions: 'Descarga Maigret OSINT:\n1. Visita https://github.com/soxoj/maigret\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! Maigret OSINT es 100% open source' }),
  makeGame({ id: 'app-web-check', title: 'Web-Check OSINT', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Herramienta OSINT todo-en-uno para analizar cualquier sitio web. DNS, headers, SSL, tecnologías, SEO, seguridad. Dashboard completo de análisis web. Software oficial: Web-Check OSINT. GitHub: https://github.com/lissy93/web-check. Estrellas: 34,667. Descarga: https://github.com/lissy93/web-check.',
    imageUrl: '/products/apps/app-web-check.svg',
    steamUrl: 'https://github.com/lissy93/web-check',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'hackeo-ético', 'premium'],
    claimInstructions: 'Descarga Web-Check OSINT:\n1. Visita https://github.com/lissy93/web-check\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! Web-Check OSINT es 100% open source' }),
  makeGame({ id: 'app-nuclei', title: 'Nuclei Scanner', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Escáner de vulnerabilidades rápido y personalizable. Basado en plantillas. Encuentra CVEs, exposición de datos, paneles de admin expuestos. Usado por pentesters profesionales. Software oficial: Nuclei Scanner. GitHub: https://github.com/projectdiscovery/nuclei. Estrellas: 31,000. Descarga: https://github.com/projectdiscovery/nuclei/releases.',
    imageUrl: '/products/apps/app-nuclei.svg',
    steamUrl: 'https://github.com/projectdiscovery/nuclei/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'hackeo-ético', 'premium'],
    claimInstructions: 'Descarga Nuclei Scanner:\n1. Visita https://github.com/projectdiscovery/nuclei/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! Nuclei Scanner es 100% open source' }),
  makeGame({ id: 'app-hydra', title: 'THC-Hydra', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Herramienta de prueba de autenticación de red. Verifica la seguridad de contraseñas en 50+ protocolos (SSH, FTP, HTTP, SMB). Para auditores de seguridad y pentesters. Software oficial: THC-Hydra. GitHub: https://github.com/vanhauser-thc/thc-hydra. Estrellas: 12,225. Descarga: https://github.com/vanhauser-thc/thc-hydra.',
    imageUrl: '/products/apps/app-hydra.svg',
    steamUrl: 'https://github.com/vanhauser-thc/thc-hydra',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'hackeo-ético', 'premium'],
    claimInstructions: 'Descarga THC-Hydra:\n1. Visita https://github.com/vanhauser-thc/thc-hydra\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! THC-Hydra es 100% open source' }),
  makeGame({ id: 'app-osv-scanner', title: 'OSV Scanner (Google)', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Escáner de vulnerabilidades de Google. Usa la base de datos OSV. Escanea dependencias, paquetes y código. Encuentra CVEs en tu software. Software oficial: OSV Scanner (Google). GitHub: https://github.com/google/osv-scanner. Estrellas: 10,970. Descarga: https://github.com/google/osv-scanner/releases.',
    imageUrl: '/products/apps/app-osv-scanner.svg',
    steamUrl: 'https://github.com/google/osv-scanner/releases',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'hackeo-ético', 'premium'],
    claimInstructions: 'Descarga OSV Scanner (Google):\n1. Visita https://github.com/google/osv-scanner/releases\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! OSV Scanner (Google) es 100% open source' }),
  makeGame({ id: 'app-safeline-waf', title: 'SafeLine WAF', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Firewall de aplicaciones web self-hosted. Protege tus sitios web de ataques. Detecta SQL injection, XSS, CSRF. Alternativa libre a Cloudflare WAF. Software oficial: SafeLine WAF. GitHub: https://github.com/chaitin/SafeLine. Estrellas: 22,487. Descarga: https://github.com/chaitin/SafeLine.',
    imageUrl: '/products/apps/app-safeline-waf.svg',
    steamUrl: 'https://github.com/chaitin/SafeLine',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'hackeo-ético', 'premium'],
    claimInstructions: 'Descarga SafeLine WAF:\n1. Visita https://github.com/chaitin/SafeLine\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! SafeLine WAF es 100% open source' }),
  makeGame({ id: 'app-payloads-all-things', title: 'PayloadsAllTheThings', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Lista de payloads útiles para pentesting web. Bypass, inyecciones, exploits. Referencia esencial para pentesters y bug bounty hunters. Documentación viva de seguridad. Software oficial: PayloadsAllTheThings. GitHub: https://github.com/swisskyrepo/PayloadsAllTheThings. Estrellas: 80,609. Descarga: https://github.com/swisskyrepo/PayloadsAllTheThings.',
    imageUrl: '/products/apps/app-payloads-all-things.svg',
    steamUrl: 'https://github.com/swisskyrepo/PayloadsAllTheThings',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'key', rating: 5,
    tags: ['software', 'open-source', 'ai', 'github', 'hackeo-ético', 'premium'],
    claimInstructions: 'Descarga PayloadsAllTheThings:\n1. Visita https://github.com/swisskyrepo/PayloadsAllTheThings\n2. Descarga la ultima version\n3. Ejecuta el instalador\n4. ¡Listo! PayloadsAllTheThings es 100% open source' }),
