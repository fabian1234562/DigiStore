...
4. ¡Empieza a streamear!` }),
  ...
  makeGame({ id: 'app-rvc-webui', title: 'RVC Voice Cloning WebUI', source: 'software', originalPrice: 59.99, genre: 'IA Clonación de Voz',
    description: 'Clona cualquier voz con menos de 10 minutos de audio. Entrena tu modelo de voz personal. La herramienta de clonación de voz open source más popular del mundo. Crea covers de canciones, voces personalizadas, doblaje. com/RVC-Project/Retrieval-based-Voice-Conversion-WebUI. . com/RVC-Project/Retrieval-based-Voice-Conversion-WebUI/releases.',
  ...
  makeGame({ id: 'app-gpt-sovits', title: 'GPT-SoVITS', source: 'software', originalPrice: 59.99, genre: 'IA Clonación de Voz',
    description: 'Clona una voz con solo 1 minuto de audio. Soporta múltiples idiomas incluyendo español. IA de última generación para clonación de voz y TTS. La más avanzada open source. com/RVC-Boss/GPT-SoVITS. . com/RVC-Boss/GPT-SoVITS/releases.',
  ...
  makeGame({ id: 'app-so-vits-svc', title: 'So-VITS-SVC', source: 'software', originalPrice: 59.99, genre: 'IA Clonación de Voz',
    description: 'Conversión de voz para cantar. Transforma tu voz en la de cualquier cantante. Soporta entrenamiento con datasets pequeños. Ideal para covers musicales con IA. com/svc-develop-team/so-vits-svc. . com/svc-develop-team/so-vits-svc/releases.',
  ...
  makeGame({ id: 'app-coqui-tts', title: 'Coqui TTS', source: 'software', originalPrice: 59.99, genre: 'IA Texto a Voz',
    description: 'Toolkit de texto a voz con deep learning. Soporta múltiples voces, idiomas y modelos. Genera voz natural desde texto. La mejor alternativa open source a ElevenLabs. com/coqui-ai/TTS. . com/coqui-ai/TTS/releases.',
  ...
  makeGame({ id: 'app-voicebox', title: 'Voicebox AI Studio', source: 'software', originalPrice: 59.99, genre: 'IA Texto a Voz',
    description: 'Estudio de voz IA open source. Clona voces, dicta, crea narraciones. La alternativa libre a ElevenLabs y Murf. Interfaz intuitiva para creadores de contenido. com/jamiepine/voicebox. . com/jamiepine/voicebox/releases.',
  ...
  makeGame({ id: 'app-cosyvoice', title: 'CosyVoice', source: 'software', originalPrice: 59.99, genre: 'IA Texto a Voz',
    description: 'Modelo de generación de voz multilingüe. Soporta español, inglés, chino y más. Clonación de voz con alta fidelidad. TTS con control de emoción. com/QwenAudio/CosyVoice. . com/QwenAudio/CosyVoice.',
  ...
  makeGame({ id: 'app-moneyprinter', title: 'MoneyPrinterTurbo', source: 'software', originalPrice: 59.99, genre: 'IA Generación de Video',
    description: 'Genera videos cortos en HD automáticamente con IA. Solo ingresa un tema o palabra clave y la IA crea el video completo con guion, voz, subtítulos y visuales. Para TikTok, YouTube Shorts, Reels. com/harry0703/MoneyPrinterTurbo. . com/harry0703/MoneyPrinterTurbo/releases.',
  ...
  makeGame({ id: 'app-cogvideo', title: 'CogVideoX', source: 'software', originalPrice: 59.99, genre: 'IA Generación de Video',
    description: 'Generación de video desde texto e imagen con IA. Crea videos desde descripciones textuales. Modelo de última generación de Zhipu AI. Open source. com/zai-org/CogVideo. . com/zai-org/CogVideo.',
  ...
  makeGame({ id: 'app-ltx-video', title: 'LTX-Video', source: 'software', originalPrice: 59.99, genre: 'IA Generación de Video',
    description: 'Generador de video con IA de Lightricks. Crea videos desde texto con alta calidad. Modelo de difusión para video. Open source, rápido y eficiente. com/Lightricks/LTX-Video. . com/Lightricks/LTX-Video.',
  ...
  makeGame({ id: 'app-deep-live-cam', title: 'Deep-Live-Cam', source: 'software', originalPrice: 59.99, genre: 'IA Face Swap',
    description: 'Face swap en tiempo real para streaming y videollamadas. Cambia tu cara por la de cualquier persona en vivo. Detección facial con IA. Para OBS, Zoom, Discord. com/hacksider/Deep-Live-Cam. . com/hacksider/Deep-Live-Cam/releases.',
  ...
  makeGame({ id: 'app-faceswap', title: 'FaceSwap (Deepfakes)', source: 'software', originalPrice: 59.99, genre: 'IA Face Swap',
    description: 'Software de deepfakes para todos. Crea videos con intercambio de rostros. La herramienta de deepfake open source más popular. Para creadores de contenido. com/deepfakes/faceswap. . com/deepfakes/faceswap/releases.',
  ...
  makeGame({ id: 'app-deepfacelive', title: 'DeepFaceLive', source: 'software', originalPrice: 59.99, genre: 'IA Face Swap',
    description: 'Face swap en tiempo real para PC streaming. Intercambia tu rostro en videollamadas y streams. Compatible con webcam. Detección facial avanzada. com/iperov/DeepFaceLive. . com/iperov/DeepFaceLive/releases.',
  ...
  makeGame({ id: 'app-deepfacelab', title: 'DeepFaceLab', source: 'software', originalPrice: 59.99, genre: 'IA Face Swap',
    description: 'El software líder para crear deepfakes. Máxima calidad de intercambio de rostros. Usado por creadores profesionales. La herramienta de deepfake más potente. com/iperov/DeepFaceLab. . com/iperov/DeepFaceLab/releases.',
  ...
  makeGame({ id: 'app-sd-webui', title: 'Stable Diffusion WebUI', source: 'software', originalPrice: 59.99, genre: 'IA Generación de Imagen',
    description: 'Interfaz web de Stable Diffusion. Genera imágenes desde texto con IA. La herramienta de generación de imágenes open source más popular. Miles de modelos disponibles. Alternativa libre a Midjourney. com/AUTOMATIC1111/stable-diffusion-webui. . com/AUTOMATIC1111/stable-diffusion-webui/releases.',
  ...
  makeGame({ id: 'app-comfyui', title: 'ComfyUI', source: 'software', originalPrice: 59.99, genre: 'IA Generación de Imagen',
    description: 'Interfaz modular y potente para modelos de difusión. Flujo de nodos visual para generación de imágenes. La herramienta más flexible para artistas de IA. Soporta Stable Diffusion y más. com/Comfy-Org/ComfyUI. . com/comfyanonymous/ComfyUI/releases.',
  ...
  makeGame({ id: 'app-whisper-cpp', title: 'Whisper.cpp', source: 'software', originalPrice: 59.99, genre: 'IA Transcripción',
    description: 'Port de Whisper de OpenAI en C/C++. Transcripción de audio a texto de alta calidad. Funciona offline, sin internet. Soporta 99 idiomas. Rápido y ligero. cpp. com/ggml-org/whisper.cpp. . com/ggml-org/whisper.cpp/releases.',
  ...
  makeGame({ id: 'app-whisperx', title: 'WhisperX', source: 'software', originalPrice: 59.99, genre: 'IA Transcripción',
    description: 'Reconocimiento de voz con alineación a nivel de palabra. Transcripción precisa con timestamps por palabra. Soporta identificación de hablantes. Mejora del Whisper de OpenAI. com/m-bain/whisperX. . com/m-bain/whisperX/releases.',
  ...
  makeGame({ id: 'app-ollama', title: 'Ollama', source: 'software', originalPrice: 59.99, genre: 'IA Chat Local',
    description: 'Ejecuta LLMs (Llama, Mistral, Gemma, Phi) localmente en tu PC. Sin internet, sin nube. Tu IA privada y personal. La forma más fácil de usar LLMs localmente. Alternativa libre a ChatGPT. com/ollama/ollama. . com/download.',
  ...
  makeGame({ id: 'app-khoj', title: 'Khoj AI', source: 'software', originalPrice: 59.99, genre: 'IA Chat Local',
    description: 'Tu segundo cerebro con IA. Self-hostable. Busca respuestas en tus documentos, emails y notas. Chat con IA sobre tu conocimiento personal. Alternativa libre a Notion AI. com/khoj-ai/khoj. . dev/download.',
  ...
  makeGame({ id: 'app-livetalking', title: 'LiveTalking', source: 'software', originalPrice: 59.99, genre: 'IA Lip Sync',
    description: 'Humano digital interactivo en tiempo real. Lip sync con IA para streaming. Crea avatares que hablan en vivo. Combinable con TTS y LLMs. com/lipku/LiveTalking. . com/lipku/LiveTalking.',
  ...
  makeGame({ id: 'app-sherlock', title: 'Sherlock OSINT', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Busca cuentas de redes sociales por nombre de usuario en 400+ plataformas. Herramienta OSINT open source para investigadores y periodistas. Encuentra perfiles en redes sociales. com/sherlock-project/sherlock. . com/sherlock-project/sherlock.',
  ...
  makeGame({ id: 'app-imhex', title: 'ImHex Hex Editor', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Editor hex para ingenieros inversos. Analiza binarios, firmware, malware. Soporta patrones, ensamblador, decompilador. La herramienta de reverse engineering más popular. com/WerWolv/ImHex. . com/WerWolv/ImHex/releases.',
  ...
  makeGame({ id: 'app-trivy', title: 'Trivy Vulnerability Scanner', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Escáner de vulnerabilidades para contenedores, Kubernetes, IaC. Encuentra CVEs, secretos, misconfiguraciones. Herramienta esencial para DevSecOps. com/aquasecurity/trivy. . com/aquasecurity/trivy/releases.',
  ...
  makeGame({ id: 'app-maigret', title: 'Maigret OSINT', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Recopila un dossier completo de una persona por su nombre de usuario. Busca en 2000+ sitios. Herramienta OSINT para investigadores. Encuentra perfiles, datos y conexiones. com/soxoj/maigret. . com/soxoj/maigret.',
  ...
  makeGame({ id: 'app-web-check', title: 'Web-Check OSINT', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Herramienta OSINT todo-en-uno para analizar cualquier sitio web. DNS, headers, SSL, tecnologías, SEO, seguridad. Dashboard completo de análisis web. com/lissy93/web-check. . com/lissy93/web-check.',
  ...
  makeGame({ id: 'app-nuclei', title: 'Nuclei Scanner', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Escáner de vulnerabilidades rápido y personalizable. Basado en plantillas. Encuentra CVEs, exposición de datos, paneles de admin expuestos. Usado por pentesters profesionales. com/projectdiscovery/nuclei. . com/projectdiscovery/nuclei/releases.',
  ...
  makeGame({ id: 'app-hydra', title: 'THC-Hydra', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Herramienta de prueba de autenticación de red. Verifica la seguridad de contraseñas en 50+ protocolos (SSH, FTP, HTTP, SMB). Para auditores de seguridad y pentesters. com/vanhauser-thc/thc-hydra. . com/vanhauser-thc/thc-hydra.',
  ...
  makeGame({ id: 'app-osv-scanner', title: 'OSV Scanner (Google)', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Escáner de vulnerabilidades de Google. Usa la base de datos OSV. Escanea dependencias, paquetes y código. Encuentra CVEs en tu software. com/google/osv-scanner. . com/google/osv-scanner/releases.',
  ...
  makeGame({ id: 'app-safeline-waf', title: 'SafeLine WAF', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Firewall de aplicaciones web self-hosted. Protege tus sitios web de ataques. Detecta SQL injection, XSS, CSRF. Alternativa libre a Cloudflare WAF. com/chaitin/SafeLine. . com/chaitin/SafeLine.',
  ...
  makeGame({ id: 'app-payloads-all-things', title: 'PayloadsAllTheThings', source: 'software', originalPrice: 59.99, genre: 'Hackeo Ético',
    description: 'Lista de payloads útiles para pentesting web. Bypass, inyecciones, exploits. Referencia esencial para pentesters y bug bounty hunters. Documentación viva de seguridad. com/swisskyrepo/PayloadsAllTheThings. . com/swisskyrepo/PayloadsAllTheThings.',
