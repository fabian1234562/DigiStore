...
export const SEED_GAMES: ScannedGame[] = [
  ...
  makeGame({ id: 'app-gimp', title: 'GIMP', source: 'software', originalPrice: 0, genre: 'Edición de imagen',
    ...
    imageUrl: '/products/apps/app-gimp.svg',
...
4. Crea gráficos vectoriales profesionalmente` }),
  makeGame({ id: 'app-krita-desktop', title: 'Krita (Desktop)', source: 'software', originalPrice: 0, genre: 'Pintura digital',
    ...
    imageUrl: '/products/apps/app-krita-desktop.svg',
...
4. ¡Empieza a pintar!` }),
  makeGame({ id: 'app-libreoffice', title: 'LibreOffice', source: 'software', originalPrice: 0, genre: 'Ofimática',
    ...
    imageUrl: '/products/apps/app-libreoffice.svg',
...
4. ¡Suite completa gratis y sin límites!` }),
  makeGame({ id: 'app-openoffice', title: 'Apache OpenOffice', source: 'software', originalPrice: 0, genre: 'Ofimática',
    ...
    imageUrl: '/products/apps/app-openoffice.svg',
...
4. Suite de oficina completa gratis` }),
  makeGame({ id: 'app-audacity-real', title: 'Audacity (Real)', source: 'software', originalPrice: 0, genre: 'Edición de audio',
    ...
    imageUrl: '/products/apps/app-audacity-real.svg',
...
4. Graba y edita audio profesional` }),
  makeGame({ id: 'app-lmms', title: 'LMMS', source: 'software', originalPrice: 0, genre: 'Producción musical',
    ...
    imageUrl: '/products/apps/app-lmms.svg',
...
4. ¡Crea música electrónica!` }),
  makeGame({ id: 'app-ardour', title: 'Ardour', source: 'software', originalPrice: 0, genre: 'Producción musical',
    ...
    imageUrl: '/products/apps/app-ardour.svg',
...
4. DAW profesional completo gratis` }),
  makeGame({ id: 'app-musescore', title: 'MuseScore', source: 'software', originalPrice: 0, genre: 'Partituras',
    ...
    imageUrl: '/products/apps/app-musescore.svg',
...
4. Crea partituras profesionales` }),
  makeGame({ id: 'app-openshot', title: 'OpenShot', source: 'software', originalPrice: 0, genre: 'Edición de video',
    ...
    imageUrl: '/products/apps/app-openshot.svg',
...
4. Convierte videos a cualquier formato` }),
  makeGame({ id: 'app-vlc', title: 'VLC media player', source: 'software', originalPrice: 0, genre: 'Reproductor multimedia',
    ...
    imageUrl: '/products/apps/app-vlc.svg',
...
4. Reproductor ligero y potente` }),
  makeGame({ id: 'app-notepadpp', title: 'Notepad++', source: 'software', originalPrice: 0, genre: 'Editor de texto',
    ...
    imageUrl: '/products/apps/app-notepadpp.svg',
...
4. Editor potente y gratis` }),
  makeGame({ id: 'app-vscode', title: 'Visual Studio Code', source: 'software', originalPrice: 0, genre: 'Editor de código',
    ...
    imageUrl: '/products/apps/app-vscode.svg',
...
4. Editor de código líder` }),
  makeGame({ id: 'app-firefox', title: 'Mozilla Firefox', source: 'software', originalPrice: 0, genre: 'Navegador web',
    ...
    imageUrl: '/products/apps/app-firefox.svg',
...
4. Navegador libre y privado` }),
  makeGame({ id: 'app-thunderbird', title: 'Mozilla Thunderbird', source: 'software', originalPrice: 0, genre: 'Cliente de email',
    ...
    imageUrl: '/products/apps/app-thunderbird.svg',
...
4. Cliente de email completo y gratis` }),
  makeGame({ id: 'app-7zip', title: '7-Zip', source: 'software', originalPrice: 0, genre: 'Compresión de archivos',
    ...
    imageUrl: '/products/apps/app-7zip.svg',
...
4. Comprime y descomprime sin límites` }),
  makeGame({ id: 'app-filezilla', title: 'FileZilla', source: 'software', originalPrice: 0, genre: 'Cliente FTP/SFTP',
    ...
    imageUrl: '/products/apps/app-filezilla.svg',
...
4. Sube archivos a cualquier servidor` }),
  makeGame({ id: 'app-rufus', title: 'Rufus', source: 'software', originalPrice: 0, genre: 'Creación de USB booteable',
    ...
    imageUrl: '/products/apps/app-rufus.svg',
...
4. Crea USB booteable fácil` }),
  makeGame({ id: 'app-etcher', title: 'balenaEtcher', source: 'software', originalPrice: 0, genre: 'Creación de USB booteable',
    ...
    imageUrl: '/products/apps/app-etcher.svg',
...
4. Edita fotos RAW profesionalmente` }),
  makeGame({ id: 'app-rawtherapee', title: 'RawTherapee', source: 'software', originalPrice: 0, genre: 'Edición fotográfica',
    ...
    imageUrl: '/products/apps/app-rawtherapee.svg',
...
4. Procesa fotos RAW como un profesional` }),
  makeGame({ id: 'app-pencil2d', title: 'Pencil2D', source: 'software', originalPrice: 0, genre: 'Animación 2D',
    ...
    imageUrl: '/products/apps/app-pencil2d.svg',
...
4. Crea animaciones 2D` }),
  makeGame({ id: 'app-synfig', title: 'Synfig Studio', source: 'software', originalPrice: 0, genre: 'Animación 2D',
    ...
    imageUrl: '/products/apps/app-synfig.svg',
...
4. Animación 2D vectorial potente` }),
  makeGame({ id: 'app-obs-studio-desktop', title: 'OBS Studio (Desktop)', source: 'software', originalPrice: 0, genre: 'Streaming',
    ...
    imageUrl: '/products/apps/app-obs-studio-desktop.svg',
    steamUrl: 'https://obsproject.com/download',
    platform: ['PC', 'Mac', 'Linux'], deliveryType: 'claim-link', rating: 5,
...
4. ¡Empieza a streamear!` }),
  ...
  makeGame({ id: 'app-vscodium-real', title: 'VSCodium', source: 'software', originalPrice: 0, genre: 'Editor de código',
    description: 'VS Code sin telemetría ni tracking de Microsoft. 100% open source MIT. Mismo motor que VS Code pero sin marca ni recopilación de datos. Editor de código líder. Software oficial: VSCodium. Repositorio GitHub: https://github.com/VSCodium/vscodium. Estrellas: 33,099. Descarga desde https://vscodium.com.',
    imageUrl: '/products/apps/app-vscodium-real.svg',
  ...
  makeGame({ id: 'app-helix', title: 'Helix Editor', source: 'software', originalPrice: 0, genre: 'Editor de código',
    description: 'Editor de texto modal post-moderno escrito en Rust. Lightning-fast, sin plugins, modo Vim mejorado. Para desarrolladores que aman la velocidad. Software oficial: Helix Editor. Repositorio GitHub: https://github.com/helix-editor/helix. Estrellas: 46,072. Descarga desde https://helix-editor.com.',
  ...
  makeGame({ id: 'app-lapce', title: 'Lapce Editor', source: 'software', originalPrice: 0, genre: 'Editor de código',
    description: 'Editor de código lightning-fast escrito en Rust. Potente, ligero y moderno. Alternativa libre a VS Code con mejor performance. Software oficial: Lapce Editor. Repositorio GitHub: https://github.com/lapce/lapce. Estrellas: 38,816. Descarga desde https://lapce.dev.',
    imageUrl: '/products/apps/app-lapce.svg',
  ...
  makeGame({ id: 'app-lossless-cut', title: 'LosslessCut', source: 'software', originalPrice: 0, genre: 'Edición de video',
    description: 'La navaja suiza de la edición lossless de video/audio. Corta sin recodificar, manteniendo calidad original. Ultra rápido. Multiplataforma. Software oficial: LosslessCut. Repositorio GitHub: https://github.com/mifi/lossless-cut. Estrellas: 43,429. Descarga desde https://losslesscut.app.',
  ...
  makeGame({ id: 'app-olive-editor', title: 'Olive Video Editor', source: 'software', originalPrice: 0, genre: 'Edición de video',
    description: 'Editor de video no-lineal open source. Alternativa libre a Premiere Pro. Soporta efectos, transiciones, multi-track. Para creadores profesionales. Software oficial: Olive Video Editor. Repositorio GitHub: https://github.com/olive-editor/olive. Estrellas: 9,128. Descarga desde https://olivevideoeditor.org.',
  ...
  makeGame({ id: 'app-files-win', title: 'Files App', source: 'software', originalPrice: 0, genre: 'Utilidades PC',
    description: 'File manager moderno para Windows. Alternativa libre al Explorer. Pestañas, dual-pane, integración con OneDrive. Diseño premium. Software oficial: Files App. Repositorio GitHub: https://github.com/files-community/Files. Estrellas: 44,874. Descarga desde https://files.community.',
    imageUrl: '/products/apps/app-files-win.svg',
  ...
  makeGame({ id: 'app-filebrowser', title: 'File Browser', source: 'software', originalPrice: 0, genre: 'Utilidades PC',
    description: 'Gestor de archivos web self-hosted. Sube, descarga, organiza archivos desde el navegador. Ideal para servidores NAS y proyectos self-hosted. Software oficial: File Browser. Repositorio GitHub: https://github.com/filebrowser/filebrowser. Estrellas: 35,969. Descarga desde https://filebrowser.org.',
    imageUrl: '/products/apps/app-filebrowser.svg',
  ...
  makeGame({ id: 'app-excalidraw', title: 'Excalidraw', source: 'software', originalPrice: 0, genre: 'Diseño vectorial',
    description: 'Pizarra virtual para dibujar diagramas estilo hand-drawn. Colaborativo en tiempo real. Ideal para wireframes, diagramas, mockups. Sin instalación. Software oficial: Excalidraw. Repositorio GitHub: https://github.com/excalidraw/excalidraw. Estrellas: 131,092. Descarga desde https://excalidraw.com.',
  ...
  makeGame({ id: 'app-jspaint', title: 'JS Paint', source: 'software', originalPrice: 0, genre: 'Edición de imagen',
    description: 'El clásico MS Paint revivido para web. Open source. Dibuja, pinta y edita imágenes al estilo retro. Funciona offline. Software oficial: JS Paint. Repositorio GitHub: https://github.com/1j01/jspaint. Estrellas: 7,868. Descarga desde https://jspaint.app.',
    imageUrl: '/products/apps/app-jspaint.svg',
  ...
  makeGame({ id: 'app-ladybird', title: 'Ladybird Browser', source: 'software', originalPrice: 0, genre: 'Navegador web',
    description: 'Browser web verdaderamente independiente. No basado en Chromium o Gecko. Construido desde cero. Proyecto ambicioso y libre. Software oficial: Ladybird Browser. Repositorio GitHub: https://github.com/LadybirdBrowser/ladybird. Estrellas: 65,994. Descarga desde https://ladybird.org.',
    imageUrl: '/products/apps/app-ladybird.svg',
  ...
  makeGame({ id: 'app-alacritty', title: 'Alacritty', source: 'software', originalPrice: 0, genre: 'Editor de código',
    description: 'Emulador de terminal cross-platform basado en OpenGL. Ultra rápido. Acelerado por GPU. Configurable. Escrito en Rust. Software oficial: Alacritty. Repositorio GitHub: https://github.com/alacritty/alacritty. Estrellas: 65,611. Descarga desde https://alacritty.org.',
    imageUrl: '/products/apps/app-alacritty.svg',
  ...
  makeGame({ id: 'app-tabby', title: 'Tabby Terminal', source: 'software', originalPrice: 0, genre: 'Editor de código',
    description: 'Terminal moderna para la nueva era. Pestañas, SSH, serial, remote. Multiplataforma. Alternativa libre a Termius. Software oficial: Tabby Terminal. Repositorio GitHub: https://github.com/Eugeny/tabby. Estrellas: 74,307. Descarga desde https://tabby.sh.',
    imageUrl: '/products/apps/app-tabby.svg',
  ...
  makeGame({ id: 'app-windows-terminal', title: 'Windows Terminal', source: 'software', originalPrice: 0, genre: 'Editor de código',
    description: 'El nuevo Windows Terminal oficial de Microsoft. Pestañas, perfiles, themes, Unicode. Open source MIT. Estándar moderno. Software oficial: Windows Terminal. Repositorio GitHub: https://github.com/microsoft/terminal. Estrellas: 104,789. Descarga desde https://aka.ms/terminal.',
    imageUrl: '/products/apps/app-windows-terminal.svg',
  ...
  makeGame({ id: 'app-lazygit', title: 'Lazygit', source: 'software', originalPrice: 0, genre: 'Editor de código',
    description: 'UI simple en terminal para comandos git. Visualiza commits, branches, merges, conflicts. Acelera tu workflow Git. Software oficial: Lazygit. Repositorio GitHub: https://github.com/jesseduffield/lazygit. Estrellas: 81,956. Descarga desde https://lazygit.org.',
    imageUrl: '/products/apps/app-lazygit.svg',
  ...
  makeGame({ id: 'app-kap', title: 'Kap', source: 'software', originalPrice: 0, genre: 'Streaming Software',
    description: 'Screen recorder open source para macOS. Graba pantalla con calidad. Exporta a GIF, MP4, WebM. Diseño elegante. Software oficial: Kap. Repositorio GitHub: https://github.com/wulkano/Kap. Estrellas: 19,345. Descarga desde https://getkap.co.',
    imageUrl: '/products/apps/app-kap.svg',
  ...
  makeGame({ id: 'app-tinode', title: 'Tinode Chat', source: 'software', originalPrice: 0, genre: 'Cliente de email',
    description: 'Plataforma de mensajería instantánea open source. Backend en Go. Clients iOS, Android, web. Self-hostable. Alternativa a WhatsApp/Telegram. Software oficial: Tinode Chat. Repositorio GitHub: https://github.com/tinode/chat. Estrellas: 13,473. Descarga desde https://tinode.co.',
    imageUrl: '/products/apps/app-tinode.svg',
  ...
  makeGame({ id: 'app-lutris', title: 'Lutris', source: 'software', originalPrice: 0, genre: 'Utilidades PC',
    description: 'Cliente de gaming para Linux. Gestiona juegos de Steam, GOG, Epic, Battle.net, emuladores. Instala y configura juegos automáticamente. Software oficial: Lutris. Repositorio GitHub: https://github.com/lutris/lutris. Estrellas: 10,212. Descarga desde https://lutris.net.',
    imageUrl: '/products/apps/app-lutris.svg',
  ...
  makeGame({ id: 'app-keepassdx', title: 'KeePassDX', source: 'software', originalPrice: 0, genre: 'Privacidad',
    description: 'Gestor de contraseñas ligero para Android. Almacén encriptado local. Offline-first. Sincronización opcional. Privado y seguro. Software oficial: KeePassDX. Repositorio GitHub: https://github.com/Kunzisoft/KeePassDX. Estrellas: 7,229. Descarga desde https://www.keepassdx.com.',
    imageUrl: '/products/apps/app-keepassdx.svg',
  ...
  makeGame({ id: 'app-gopass', title: 'gopass', source: 'software', originalPrice: 0, genre: 'Privacidad',
    description: 'Gestor de contraseñas estándar unix mejorado. CLI + integración con equipos. Open source. Alternativa libre a 1Password. Software oficial: gopass. Repositorio GitHub: https://github.com/gopasspw/gopass. Estrellas: 7,119. Descarga desde https://www.gopass.pw.',
    imageUrl: '/products/apps/app-gopass.svg',
  ...
  makeGame({ id: 'app-gh-appflowy', title: 'AppFlowy', source: 'software', originalPrice: 0, genre: 'Ofimática',
    description: 'Bring projects, wikis, and teams together with AI. AppFlowy is the AI collaborative workspace where you achieve more without losing control of your data. The leading open source Notion alternative. Software oficial: AppFlowy. GitHub: https://github.com/AppFlowy-IO/AppFlowy. Estrellas: 76,237. Descarga: https://appflowy.com.',
    imageUrl: '/products/apps/app-gh-appflowy.svg',
  ...
  makeGame({ id: 'app-marktext', title: 'MarkText', source: 'software', originalPrice: 0, genre: 'Editor de texto',
    description: 'Editor de Markdown simple y elegante. Vista previa en tiempo real. Alternativa libre a Typora. Para escribir notas y documentación. Software oficial: MarkText. GitHub: https://github.com/marktext/marktext. Estrellas: 60,984. Descarga: https://www.marktext.cc.',
    imageUrl: '/products/apps/app-marktext.svg',
  ...
  makeGame({ id: 'app-logseq', title: 'Logseq', source: 'software', originalPrice: 0, genre: 'Editor de texto',
    description: 'Base de conocimiento open source privacy-first. Notas, tareas, journal. Soporta Markdown y Org-mode. Alternativa libre a Notion y Roam Research. Software oficial: Logseq. GitHub: https://github.com/logseq/logseq. Estrellas: 44,750. Descarga: https://logseq.com.',
  ...
  makeGame({ id: 'app-siyuan', title: 'SiYuan', source: 'software', originalPrice: 0, genre: 'Editor de texto',
    description: 'Editor de notas personal WYSIWYG. Privacy-first, self-hosted. Bloques, backlinks, query. Alternativa libre a Notion. Software oficial: SiYuan. GitHub: https://github.com/siyuan-note/siyuan. Estrellas: 46,151. Descarga: https://b3log.org/siyuan.',
    imageUrl: '/products/apps/app-siyuan.svg',
  ...
  makeGame({ id: 'app-xournalpp', title: 'Xournal++', source: 'software', originalPrice: 0, genre: 'Editor de texto',
    description: 'Software de notas a mano con soporte para tabletas gráficas. Anotaciones en PDF, dibujo, escritura. Ideal para estudiantes y profesionales. Software oficial: Xournal++. GitHub: https://github.com/xournalpp/xournalpp. Estrellas: 15,318. Descarga: https://xournalpp.github.io.',
    imageUrl: '/products/apps/app-xournalpp.svg',
  ...
  makeGame({ id: 'app-keepassxc', title: 'KeePassXC', source: 'software', originalPrice: 0, genre: 'Privacidad',
    description: 'Gestor de contraseñas cross-platform. Almacén encriptado local. Sin nube, sin tracking. Alternativa libre a 1Password. Privado y seguro. Software oficial: KeePassXC. GitHub: https://github.com/keepassxreboot/keepassxc. Estrellas: 16,999. Descarga: https://keepassxc.org.',
    imageUrl: '/products/apps/app-keepassxc.svg',
  ...
  makeGame({ id: 'app-bitwarden', title: 'Bitwarden', source: 'software', originalPrice: 0, genre: 'Privacidad',
    description: 'El gestor de contraseñas open source más popular. Sincronización en la nube, multiplataforma. Extensions para todos los browsers. Free y premium. Software oficial: Bitwarden. GitHub: https://github.com/bitwarden/clients. Estrellas: 15,000. Descarga: https://bitwarden.com.',
  ...
  makeGame({ id: 'app-flameshot', title: 'Flameshot', source: 'software', originalPrice: 0, genre: 'Screenshot Tool',
    description: 'Software de screenshot potente y fácil de usar. Anotaciones, edición, upload. Para Windows, Mac y Linux. Alternativa libre a Snagit. Software oficial: Flameshot. GitHub: https://github.com/flameshot-org/flameshot. Estrellas: 30,767. Descarga: https://flameshot.org.',
  ...
  makeGame({ id: 'app-peek', title: 'Peek', source: 'software', originalPrice: 0, genre: 'Screenshot Tool',
    description: 'Screen recorder simple para crear GIFs animados. Graba una región de pantalla y exporta a GIF, MP4, WebM. Para Linux. Software oficial: Peek. GitHub: https://github.com/phw/peek. Estrellas: 10,552. Descarga: https://github.com/phw/peek/releases.',
    imageUrl: '/products/apps/app-peek.svg',
  ...
  makeGame({ id: 'app-greenshot', title: 'Greenshot', source: 'software', originalPrice: 0, genre: 'Screenshot Tool',
    description: 'Screenshot tool ligero para Windows. Capturas, anotaciones, OCR, export. Alternativa libre a ShareX. Rápido y fácil. Software oficial: Greenshot. GitHub: https://github.com/greenshot/greenshot. Estrellas: 5,108. Descarga: https://getgreenshot.org.',
    imageUrl: '/products/apps/app-greenshot.svg',
  ...
  makeGame({ id: 'app-signal', title: 'Signal Desktop', source: 'software', originalPrice: 0, genre: 'Cliente de email',
    description: 'Messenger privado open source. Encriptación end-to-end. Sin tracking, sin anuncios. Alternativa libre a WhatsApp/Telegram. Por Signal Foundation. Software oficial: Signal Desktop. GitHub: https://github.com/signalapp/Signal-Desktop. Estrellas: 16,515. Descarga: https://signal.org.',
    imageUrl: '/products/apps/app-signal.svg',
  ...
  makeGame({ id: 'app-retroarch', title: 'RetroArch', source: 'software', originalPrice: 0, genre: 'Utilidades PC',
    description: 'Frontend para emuladores, juegos y reproductores multimedia. Soporta NES, SNES, Genesis, PlayStation, N64, Arcade. Miles de juegos retro. Software oficial: RetroArch. GitHub: https://github.com/libretro/RetroArch. Estrellas: 13,806. Descarga: https://www.retroarch.com.',
  ...
  makeGame({ id: 'app-pcsx2', title: 'PCSX2', source: 'software', originalPrice: 0, genre: 'Utilidades PC',
    description: 'Emulador de PlayStation 2 para PC. Juega PS2 classics en Windows, Mac y Linux. Mejora gráficos con upscaling HD. El emulador PS2 más popular. Software oficial: PCSX2. GitHub: https://github.com/PCSX2/pcsx2. Estrellas: 15,484. Descarga: https://pcsx2.net.',
    imageUrl: '/products/apps/app-pcsx2.svg',
  ...
  makeGame({ id: 'app-dosbox-x', title: 'DOSBox-X', source: 'software', originalPrice: 0, genre: 'Utilidades PC',
    description: 'Emulador de DOS completo. Ejecuta juegos y aplicaciones DOS antiguas. Soporta Windows 3.x/95/98. Para nostálgicos y retro gaming. Software oficial: DOSBox-X. GitHub: https://github.com/joncampbell123/dosbox-x. Estrellas: 3,710. Descarga: https://dosbox-x.com.',
    imageUrl: '/products/apps/app-dosbox-x.svg',
  ...
  makeGame({ id: 'app-prusaslicer', title: 'PrusaSlicer', source: 'software', originalPrice: 0, genre: '3D Modeling',
    description: 'Generador de G-code para impresoras 3D. Open source de Prusa Research. Soporta RepRap, Makerbot, Bambu Lab. El estándar de la industria 3D. Software oficial: PrusaSlicer. GitHub: https://github.com/prusa3d/PrusaSlicer. Estrellas: 9,294. Descarga: https://www.prusa3d.com/prusaslicer.',
    imageUrl: '/products/apps/app-prusaslicer.svg',
  ...
  makeGame({ id: 'app-cura', title: 'Ultimaker Cura', source: 'software', originalPrice: 0, genre: '3D Modeling',
    description: 'Software de slicing para impresoras 3D. Multiplataforma. Soporta cientos de impresoras. La elección más popular para impresión 3D. Software oficial: Ultimaker Cura. GitHub: https://github.com/Ultimaker/Cura. Estrellas: 7,029. Descarga: https://ultimaker.com/software/ultimaker-cura.',
    imageUrl: '/products/apps/app-cura.svg',
  ...
  makeGame({ id: 'app-octoprint', title: 'OctoPrint', source: 'software', originalPrice: 0, genre: '3D Modeling',
    description: 'Interfaz web para controlar impresoras 3D. Monitoreo con webcam, control remoto, plugins. El estándar para impresión 3D. Software oficial: OctoPrint. GitHub: https://github.com/OctoPrint/OctoPrint. Estrellas: 9,085. Descarga: https://octoprint.org.',
  ...
  makeGame({ id: 'app-strawberry', title: 'Strawberry Music Player', source: 'software', originalPrice: 0, genre: 'Reproductor multimedia',
    description: 'Reproductor de música cross-platform. Soporta streaming, podcasts, MP3, FLAC. Integración con Spotify, Tidal, Qobuz. Alternativa libre a iTunes. Software oficial: Strawberry Music Player. GitHub: https://github.com/strawberrymusicplayer/strawberry. Estrellas: 4,000. Descarga: https://www.strawberrymusicplayer.org.',
    imageUrl: '/products/apps/app-strawberry.svg',
  ...
  makeGame({ id: 'app-clementine', title: 'Clementine Music Player', source: 'software', originalPrice: 0, genre: 'Reproductor multimedia',
    description: 'Reproductor de música multiplataforma moderno. Busca y reproduce tu música local. Soporta Spotify, Soundcloud, Google Drive, Dropbox. Software oficial: Clementine Music Player. GitHub: https://github.com/clementine-player/Clementine. Estrellas: 4,243. Descarga: https://www.clementine-player.org.',
    imageUrl: '/products/apps/app-clementine.svg',
